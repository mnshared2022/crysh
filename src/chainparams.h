 ...
 * cryshcoin system. There are three: the main network on which people trade goods
...
public:
    ...
    int cryshcoinBadBlockTime() const { return ncryshcoinBadBlockTime; }
    int cryshcoinBadBlocknBits() const { return ncryshcoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t ncryshcoinBadBlockTime;
    unsigned int ncryshcoinBadBlocknBits;
