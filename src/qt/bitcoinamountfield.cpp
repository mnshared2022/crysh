...
public:
    explicit AmountSpinBox(QWidget* parent) : QAbstractSpinBox(parent),
                                              currentUnit(BitcoinUnits::crysh),
    ...
    QSize minimumSizeHint() const
    {
        if (cachedMinimumSizeHint.isEmpty()) {
            ...
            int w = fm.width(BitcoinUnits::format(BitcoinUnits::crysh, BitcoinUnits::maxMoney(), false, BitcoinUnits::separatorAlways));
                                                          ...
                                                          amount(0)
{
    ...
    amount->setStyleSheet("QSpinBox::up-button:hover { background-color: #e1e1e1; }"
                          "QSpinBox::down-button:hover { background-color: #e1e1e1; }");
