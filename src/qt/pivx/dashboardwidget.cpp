    ...
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of CRYSH earned via Staking & Masternodes"));
	...
	ui->labelAmountMNRewards->setText("0 CRYSH");
...
bool DashboardWidget::loadChartData(bool withMonthNames)
{
    ...
    chartData->amountsByCache = getAmountBy(); // pair CRYSH
