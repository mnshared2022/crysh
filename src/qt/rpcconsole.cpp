                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzcryshPathCustom = GetArg("-zcryshbackuppath", "");
    ...
    if(!strzcryshPathCustom.empty()) {
        ui->wallet_customzcryshbackuppath->setText(QString::fromStdString(strzcryshPathCustom));
        ui->wallet_customzcryshbackuppath_label->setVisible(true);
        ui->wallet_customzcryshbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzcryshPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the cryshcoin RPC console.") + "<br>" +
