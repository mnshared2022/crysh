...
#include "config/cryshcoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qreal maxValue = 0;
    qint64 totalcrysh = 0;
    qint64 totalZcrysh = 0;
    QList<qreal> valuescrysh;
    QList<qreal> valueszcrysh;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(cryshcoinGUI* _window);
    ~DashboardWidget();
