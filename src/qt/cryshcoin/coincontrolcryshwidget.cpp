...
#include "qt/cryshcoin/coincontrolcryshwidget.h"
#include "qt/cryshcoin/forms/ui_coincontrolcryshwidget.h"

CoinControlcryshWidget::CoinControlcryshWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlcryshWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select crysh Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("crysh");
    ...
    ui->labelValueAfter->setText("0.00 crysh");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 crysh");
    ui->labelValueFee->setText("0.00 crysh");
...
CoinControlcryshWidget::~CoinControlcryshWidget()
{
    delete ui;
}
