...
#include "qt/cryshcoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/cryshcoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(cryshcoinGUI* _window, QWidget *parent) :
