...
#include "qt/cryshcoin/settings/settingssignmessagewidgets.h"
#include "qt/cryshcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(cryshcoinGUI* _window, QWidget *parent) :
