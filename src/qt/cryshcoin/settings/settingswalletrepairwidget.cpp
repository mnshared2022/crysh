...
#include "qt/cryshcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cryshcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(cryshcoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to cryshcoinGUI::handleRestart()
