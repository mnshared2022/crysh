...
#include "qt/cryshcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/cryshcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(cryshcoinGUI* _window, QWidget *parent) :
