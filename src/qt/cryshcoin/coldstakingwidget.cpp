...
#include "qt/cryshcoin/forms/ui_coldstakingwidget.h"
#include "qt/cryshcoin/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/cryshcoin/requestdialog.h"
#include "qt/cryshcoin/tooltipmenu.h"
#include "qt/cryshcoin/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(cryshcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ColdStakingWidget)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your cryshs and let a hot node (24/7 online node)\nstake in your behalf, keeping the keys in a secure place offline."));
    ...
    ui->labelSubtitle2->setText(tr("Delegate or Accept crysh delegation"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select crysh outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 crysh" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
