...
#include "qt/cryshcoin/forms/ui_receivewidget.h"
...
#include "qt/cryshcoin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(cryshcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive crysh."));
