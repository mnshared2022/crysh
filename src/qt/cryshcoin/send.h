...
#include "qt/cryshcoin/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(cryshcoinGUI* parent);
    ~SendWidget();
...
private slots:
    void oncryshSelected(bool _iscrysh);
    void onSendClicked();
...
private:
    ...
    bool sendZcrysh(QList<SendCoinsRecipient> recipients);
