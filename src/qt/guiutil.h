...
/** Utility functions used by the cryshcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render cryshcoin addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZcrysh = false);
...
// Parse "cryshcoin:" URI into recipient object, return true on successful parsing
