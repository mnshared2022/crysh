...
/** Utility functions used by the CRYSH Qt UI.
 */
namespace GUIUtil
{
...
// Render CRYSH addresses in monospace font
...
// Parse "CRYSH:" URI into recipient object, return true on successful parsing
