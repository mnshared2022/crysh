...
#ifndef cryshcoin_QT_WALLETMODEL_H
#define cryshcoin_QT_WALLETMODEL_H
...
/** Interface to cryshcoin wallet from Qt view code. */
...
#endif // cryshcoin_QT_WALLETMODEL_H
