...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("crysh Coin cryshcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryshcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryshcoin transaction") + "\n" +
                               "  cryshcoin-tx [options] -create [commands]   " + _("Create hex-encoded cryshcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryshcoin transaction
