...
{
    const char* pszTimestamp = "CRYSH 2.0 ";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x000004a541aea7ff06c97e57a69153275b92d4e61c255ac249b2e51c14c89f5f"))

;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1707503010, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1707503010, 16644556, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x000004a541aea7ff06c97e57a69153275b92d4e61c255ac249b2e51c14c89f5f"));
        assert(genesis.hashMerkleRoot == uint256S("0x98a6ae0378f60f0758e83957daf750f2576bf27c9a8898cb10ecd14ce9955c3c"));
        ...
        consensus.nMaxMoneyOut = 730000000 * COIN;
        ...
        consensus.mBurnAddresses = {
           { "CRYSHBuRnCRYSHxxxxxxxxxxxxTpDJ6", 0 }
        };
    	...
    	vSeeds.push_back(CDNSSeedData("seed1",  "seed1.crysh"));
        vSeeds.push_back(CDNSSeedData("seed2",  "seed2.crysh"));
        vSeeds.push_back(CDNSSeedData("seed3",  "seed3.crysh"));
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1707503010, 16549955, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // CRYSH starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.push_back(CDNSSeedData("tseeder", "tseeder.__crysh__", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet CRYSH addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet CRYSH script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet CRYSH BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet CRYSH BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet CRYSH BIP44 coin type is '1' (All coin's testnet default)
