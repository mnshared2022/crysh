...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CRYSH CRYSH-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  CRYSH-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded CRYSH transaction") + "\n" +
                               "  CRYSH-tx [options] -create [commands]   " + _("Create hex-encoded CRYSH transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded CRYSH transaction
