...
const char * const PIVX_CONF_FILENAME = "CRYSH.conf";
const char * const PIVX_PID_FILENAME = "CRYSH.pid";
...
{
// Windows < Vista: C:\Documents and Settings\Username\Application Data\CRYSH
// Windows >= Vista: C:\Users\Username\AppData\Roaming\CRYSH
// Mac: ~/Library/Application Support/CRYSH
// Unix: ~/.CRYSH
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "CRYSH";
#else
    fs::path pathRet;
    ...
    std::map<std::string, std::vector<std::string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()) {
        // Create empty CRYSH.conf if it does not exist
        ...
        if (configFile != NULL) {
	        ...
	        strHeader += "\nrpcport=28549\naddnode=seed1.crysh:28550\naddnode=seed2.crysh:28550\naddnode=seed3.crysh:28550\naddnode=seed4.crysh:28550\naddnode=seed5.crysh:28550\naddnode=seed6.crysh:28550\naddnode=seed7.crysh:28550\naddnode=seed8.crysh:28550\n";
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override CRYSH.conf
