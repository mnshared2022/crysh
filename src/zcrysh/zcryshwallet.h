// Copyright (c) 2017-2018 The cryshcoin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef cryshcoin_ZcryshWALLET_H
#define cryshcoin_ZcryshWALLET_H
...
public:
    CzcryshWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZcrysh(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZcrysh(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //cryshcoin_ZcryshWALLET_H
