...
#ifndef cryshcoin_ZcryshTRACKER_H
#define cryshcoin_ZcryshTRACKER_H
...
public:
    CzcryshTracker(std::string strWalletFile);
    ~CzcryshTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzcryshWallet* zcryshWallet = NULL);
...
#endif //cryshcoin_ZcryshTRACKER_H
