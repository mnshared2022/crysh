...
public:
    ...
    bool WriteZcryshSeed(const uint256& hashSeed, const std::vector<unsigned char>& seed);
    bool ReadZcryshSeed(const uint256& hashSeed, std::vector<unsigned char>& seed);
    bool ReadZcryshSeed_deprecated(uint256& seed);
    bool EraseZcryshSeed();
    bool EraseZcryshSeed_deprecated();

    bool WriteZcryshCount(const uint32_t& nCount);
    bool ReadZcryshCount(uint32_t& nCount);
