...
/**
 * cryshcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZcryshSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzcryshseed(const UniValue& params, bool fHelp);
extern UniValue getzcryshseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcrysh(const UniValue& params, bool fHelp);
extern UniValue dzcryshstate(const UniValue& params, bool fHelp);
