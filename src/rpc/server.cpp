...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop cryshcoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "cryshcoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cryshcoin features */
        {"cryshcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"cryshcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryshcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cryshcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cryshcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cryshcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cryshcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryshcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"cryshcoin", "startmasternode", &startmasternode, true, true, false},
        {"cryshcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryshcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryshcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryshcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryshcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryshcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryshcoin", "preparebudget", &preparebudget, true, true, false},
        {"cryshcoin", "submitbudget", &submitbudget, true, true, false},
        {"cryshcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cryshcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cryshcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cryshcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cryshcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cryshcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cryshcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cryshcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"cryshcoin", "mnsync", &mnsync, true, true, false},
        {"cryshcoin", "spork", &spork, true, true, false},
        {"cryshcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cryshcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:14550/\n";
}
