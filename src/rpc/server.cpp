...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CRYSH features */
        {"CRYSH", "listmasternodes", &listmasternodes, true },
        {"CRYSH", "getmasternodecount", &getmasternodecount, true },
        {"CRYSH", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"CRYSH", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"CRYSH", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"CRYSH", "masternodecurrent", &masternodecurrent, true },
        {"CRYSH", "startmasternode", &startmasternode, true },
        {"CRYSH", "createmasternodekey", &createmasternodekey, true },
        {"CRYSH", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"CRYSH", "listmasternodeconf", &listmasternodeconf, true },
        {"CRYSH", "getmasternodestatus", &getmasternodestatus, true },
        {"CRYSH", "getmasternodewinners", &getmasternodewinners, true },
        {"CRYSH", "getmasternodescores", &getmasternodescores, true },
        {"CRYSH", "mnsync", &mnsync, true },
        {"CRYSH", "spork", &spork, true },
...
{
    return "> CRYSH-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:28549/\n";
}
