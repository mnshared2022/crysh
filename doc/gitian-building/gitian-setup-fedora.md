...
The build script we'll be using is contained in the cryshcoin github repository ([contrib/gitian-build.py](https://github.com/mnshared2022/crysh/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the cryshcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/cryshcoin/cryshcoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, cryshcoin-detached-sigs, and cryshcoin GitHub repos.
