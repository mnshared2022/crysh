Contributing to crysh Coin
============================

The crysh Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/mnshared2022/crysh/blob/master/doc/translation_process.md)
...
The following applies to code changes to the crysh Coin project, and is not to be
confused with overall cryshcoin Network Protocol consensus changes.

Whether a pull request is merged into crysh Coin rests with the project merge
...
Patches that change cryshcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the cryshcoin consensus, it must have been
...
The project leader is the release manager for each crysh Coin release.
