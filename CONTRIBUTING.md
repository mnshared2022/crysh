Contributing to CRYSH Core
============================

The CRYSH Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CRYSH Core project, and is not to be
confused with overall CRYSH Network Protocol consensus changes.

Whether a pull request is merged into CRYSH Core rests with the project merge
...
Patches that change CRYSH consensus rules are considerably more involved than
...
Where a patchset proposes to change the CRYSH consensus, it must have been
...
The project leader is the release manager for each CRYSH Core release.
