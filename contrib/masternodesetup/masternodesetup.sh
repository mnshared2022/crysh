...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='CRYSH.conf'
CONFIGFOLDER='/root/.CRYSH'
COIN_DAEMON='CRYSHd'
COIN_CLI='CRYSH-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/CRYSH/CRYSH/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
