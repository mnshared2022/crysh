...
* Fill in the following data:
    * Application Name: `CRYSH Core`
    * Application Version: `2.0.0.0`
    * Application Publisher: `2021-2022 The CRYSH Developers`
    * Application Website: `https://crysh/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `CRYSH`
* Add application files:
    * Select the file `CRYSH-qt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `CRYSH-2.0.0-win64-setup.exe`
