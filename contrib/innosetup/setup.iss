...
#define MyAppName "CRYSH Core"
#define MyAppPublisher "2021-2022 The CRYSH Developers"
#define MyAppURL "https://github.com/mnshared2022/CRYSH"
#define MyAppExeName "CRYSH-qt.exe"
#define MyAppExtraData "https://github.com/mnshared2022/CRYSH/releases/download/v2.0/bootstrap.zip"
...
[Files]
Source: ".\package\CRYSH-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\CRYSH\CRYSH-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\CRYSH\CRYSH-Qt,strDataDir|{userappdata}\CRYSH\}');
  Result := True;
end;
