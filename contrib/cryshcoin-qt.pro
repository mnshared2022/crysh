...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cryshcoin-cli.cpp \
           src/cryshcoin-tx.cpp \
           src/cryshcoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/cryshcoin.qrc src/qt/cryshcoin_locale.qrc

TRANSLATIONS += src/qt/locale/cryshcoin_bg.ts \
                src/qt/locale/cryshcoin_de.ts \
                src/qt/locale/cryshcoin_en.ts \
                src/qt/locale/cryshcoin_es.ts \
                src/qt/locale/cryshcoin_fi.ts \
                src/qt/locale/cryshcoin_fr.ts \
                src/qt/locale/cryshcoin_it.ts \
                src/qt/locale/cryshcoin_ja.ts \
                src/qt/locale/cryshcoin_pl.ts \
                src/qt/locale/cryshcoin_pt.ts \
                src/qt/locale/cryshcoin_ru.ts \
                src/qt/locale/cryshcoin_sk.ts \
                src/qt/locale/cryshcoin_sv.ts \
                src/qt/locale/cryshcoin_vi.ts \
                src/qt/locale/cryshcoin_zh_CN.ts \
                src/qt/locale/cryshcoin_zh_TW.ts
