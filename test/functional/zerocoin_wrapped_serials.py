...
from fake_stake.base_test import cryshcoin_FakeStakeTest

class zcryshwrappedSerialsTest(cryshcoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zcryshs..." % DENOM_TO_USE)
