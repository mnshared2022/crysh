...
"""Verify that starting CRYSH with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start CRYSH with -? for help text")
        ...
        self.log.info("Start CRYSH with -version for version information")
