...
from test_framework.cryshcoin_node import cryshcoinTestNode
...
class cryshcoin_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(cryshcoinTestNode())
...
if __name__ == '__main__':
    cryshcoin_ColdStakingTest().main()
